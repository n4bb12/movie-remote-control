...
export enum EventCode {
  // List of code values for writing
  // system keys in the Alphanumeric section.
  Backquote = "Backquote",
  Backslash = "Backslash",
  ...
  // List of code values for functional
  ...
  // List of code values for functional
  // keys found on Japanese and Korean keyboards.
  Convert = "Convert",
  KanaMode = "KanaMode",
  Lang1 = "Lang1",
  Lang2 = "Lang2",
  ...
  // List of code values for keys in the
  // ControlPad section.
  Delete = "Delete",
  End = "End",
  Help = "Help",
